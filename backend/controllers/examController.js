...
exports.submitExam = async (req, res) => {
  try {
    ...
    // Determine CPALE Status (PRC BOA Rule: GWA >= 75% and no subject < 65%)
    let status = 'FAILED';
...
// @desc    Get all exam submissions / history (supports examineeName filter)
...
// @desc    Get specific exam submission by ID (with full answers, solutions & legal basis)
